    ...
    return (
      <AntLayout>
        <Header className="grid grid-cols-12 bg-primary w-full">
          <div className="text-3xl font-bold flex h-full items-center col-span-2">
            MACTIV
          </div>
          <Menu
            mode="horizontal"
      ...
      <AntLayout className="min-h-screen">
        ...
        >
          <Menu mode="inline" theme="dark" className="mt-16 text-lg font-bold">
            <Menu.ItemGroup
              title={<div className="mx-2 text-2xl">{!collapse && "Menu"}</div>}
            >
              <Menu.Item
                icon={
                  <div>
              ...
              >
                <Link to={"/dashboard"}>
                  <div className="text-white mr-4">Dashboard</div>
                </Link>
              </Menu.Item>
              <Menu.Item
                icon={
              ...
              >
                <Link to={"/dashboard/pelajaran"}>
                  <div className="text-white mr-4">Mata Pelajaran</div>
                </Link>
              </Menu.Item>
              <Menu.Item
                key={"tugas"}
              ...
              >
                <Link to={"/dashboard/tugas"}>
                  <div className="text-white mr-4">Tugas</div>
                </Link>
              </Menu.Item>
              <Menu.Item
                key={"credit_score"}
              ...
              >
                <Link to={"/dashboard/credit-score"}>
                  <div className="text-white mr-4">Credit Score</div>
                </Link>
              </Menu.Item>
            </Menu.ItemGroup>
          </Menu>
        ...
        <AntLayout>
          <Header className="flex justify-between bg-primary">
            <div className="text-white text-3xl font-bold flex h-full items-center">
              MACTIV
            </div>
            <div className="text-white text-xl font-bold flex h-full items-center">
              Farhan Abdul Hamid
            </div>
          </Header>
